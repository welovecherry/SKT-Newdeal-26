...
AI·자동화 기초 과목의 **아침 과제와 실습 노트북**입니다.
이 페이지 하나만 저장해 두시면 됩니다. 날짜를 찾아 들어가면 그날 자료가 다 있습니다.
...
1. 위 표에서 **주제 이름**을 누릅니다. Colab 이 열립니다.
2. **파일 › 드라이브에 사본 저장** 을 먼저 누릅니다. 사본을 만들지 않으면 쓴 코드가 저장되지 않습니다.
3. 셀 실행은 **Shift + Enter**.
4. 막히면 노트북 안의 힌트를 먼저 보고, 그래도 안 되면 맨 아래 **정답** 절의 「코드 표시」를 누릅니다.

## 아침 30분 쓰는 법

1. 위 표에서 **아침 30분** 칸을 누릅니다. 그날 과제 문서가 열립니다.
2. 명령어 정답이 적혀 있지 않은 부분은 **직접 검색해서** 찾습니다. 찾는 것까지가 과제입니다.
3. 시간 안에 못 끝내도 됩니다. 어디서 멈췄는지만 적어 두면 다음 아침에 이어서 합니다.
...
9/22~9/23 파일은 이미 배포한 링크를 살리려고 옛 이름(`YYMMDD_주제.ipynb`)으로 루트에 그대로 둡니다.
